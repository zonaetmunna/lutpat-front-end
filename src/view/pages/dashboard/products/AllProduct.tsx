...
const AllProduct = () => {
	...
	const filteredProducts = useMemo(() => {
		if (products && selectedCategory) {
			return products.filter((product: IProduct) => product.category === selectedCategory.value);
		} else {
			return products || [];
		}
	...
	const [isSingleBrandModalOpen, setIsSingleBrandModalOpen] = useState<boolean>(false);
