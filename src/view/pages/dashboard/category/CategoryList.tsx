...
import CategoryDelete from '../../../components/organisms/CategoryDelete';
import CategoryUpdate from '../../../components/organisms/CategoryUpdate';
...
const CategoryList = () => {
	...
	const [isSingleCategoriesModalOpen, setIsSingleCategoriesModalOpen] = useState<boolean>(false);
	const [isUpdateCategoriesModalOpen, setIsUpdateCategoriesModalOpen] = useState<boolean>(false);
	const [isDeleteCategoriesModalOpen, setIsDeleteCategoriesModalOpen] = useState<boolean>(false);
