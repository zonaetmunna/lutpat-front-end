						...
						<div className='bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
							...
							<div className='mt-4'>
								...
								<div className='mb-4'>
									...
									/>
									{errors.socialMedia && (
										<p className='text-red-500 text-xs italic'>{errors.socialMedia.message}</p>
									)}
								</div>
								...
								<div className='mb-4'>
									<label htmlFor='user._id' className='block text-gray-700 font-bold mb-2'>
										User ID
									</label>
									<input
										type='text'
									...
									/>
									{errors.owner && (
										<p className='text-red-500 text-xs italic'>{errors.owner.message}</p>
									)}
								</div>
							</div>
